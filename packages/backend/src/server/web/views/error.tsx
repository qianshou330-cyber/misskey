	...
	return (
		<>
			...
			<html>
				<head>
					<meta charset="UTF-8" />
					<meta name="application-name" content="NexusHub" />
					<meta name="viewport" content="width=device-width, initial-scale=1.0" />
					<meta name="referrer" content="origin" />
					<title safe>{props.title ?? 'An error has occurred... | NexusHub'}</title>
				...
				<body>
					...
					<h1 data-i18n="title">Failed to initialize NexusHub</h1>
