...
export type AdminApkResourcesDeleteRequest = operations['admin___apk___resources___delete']['requestBody']['content']['application/json'];
export type AdminApkResourcesDeleteResponse = operations['admin___apk___resources___delete']['responses']['200']['content']['application/json'];
export type AdminApkResourcesListRequest = operations['admin___apk___resources___list']['requestBody']['content']['application/json'];
export type AdminApkResourcesListResponse = operations['admin___apk___resources___list']['responses']['200']['content']['application/json'];
export type AdminApkResourcesUpdateStatusRequest = operations['admin___apk___resources___update-status']['requestBody']['content']['application/json'];
export type AdminApkResourcesUpdateStatusResponse = operations['admin___apk___resources___update-status']['responses']['200']['content']['application/json'];
...
export type ApkResourcesCreateRequest = operations['apk___resources___create']['requestBody']['content']['application/json'];
export type ApkResourcesCreateResponse = operations['apk___resources___create']['responses']['200']['content']['application/json'];
export type ApkResourcesDeleteRequest = operations['apk___resources___delete']['requestBody']['content']['application/json'];
export type ApkResourcesDownloadRequest = operations['apk___resources___download']['requestBody']['content']['application/json'];
export type ApkResourcesDownloadResponse = operations['apk___resources___download']['responses']['200']['content']['application/json'];
export type ApkResourcesListRequest = operations['apk___resources___list']['requestBody']['content']['application/json'];
export type ApkResourcesListResponse = operations['apk___resources___list']['responses']['200']['content']['application/json'];
export type ApkResourcesShowRequest = operations['apk___resources___show']['requestBody']['content']['application/json'];
export type ApkResourcesShowResponse = operations['apk___resources___show']['responses']['200']['content']['application/json'];
export type ApkResourcesUpdateRequest = operations['apk___resources___update']['requestBody']['content']['application/json'];
export type ApkResourcesUpdateResponse = operations['apk___resources___update']['responses']['200']['content']['application/json'];
export type ApkResourcesVersionsRequest = operations['apk___resources___versions']['requestBody']['content']['application/json'];
export type ApkResourcesVersionsResponse = operations['apk___resources___versions']['responses']['200']['content']['application/json'];
